...
// Default face parts
const defaultEyes = "❛"
const defaultEyebrows = "͡"
const defaultNose = "͜ʖ"
const defaultMouth = "͡"
    ...
    <div className="rounded-lg overflow-hidden">
      ...
      <div className="grid grid-cols-4 bg-white">
        ...
        <div className="border-r border-gray-200 max-h-[500px] overflow-y-auto">
          <div className="p-2 text-center text-black bg-gray-100 font-medium">Wrappers</div>
        ...
        {/* Column 2 - Eyes */}
        <div className="border-r border-gray-200 max-h-[500px] overflow-y-auto">
          <div className="p-2 text-center text-black bg-gray-100 font-medium">Eyes</div>
        ...
        {/* Column 3 - Eyebrows */}
        <div className="border-r border-gray-200 max-h-[500px] overflow-y-auto">
          <div className="p-2 text-center text-black bg-gray-100 font-medium">Eyebrows</div>
        ...
        <div className="max-h-[500px] overflow-y-auto">
          <div className="p-2 text-center text-black bg-gray-100 font-medium">Nose & Mouth</div>
