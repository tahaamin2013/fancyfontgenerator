...
export default function SpecialCharactersPage() {
  ...
  return (
    ...
    <head>
      <title>Tabella dei Caratteri Speciali HTML</title>
      <meta name="description" content="Consulta e copia facilmente i caratteri speciali HTML più comuni. Tabella completa con descrizione, codice HTML e carattere." />
    </head>
